...
class KRASS:
    ...
    def kanserbutonlarıvesagpanel(self,isim,soyisim,yas):
        ...
        akcıger_renk = "red" if self.kanser_riskleri["akciger"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
        ...
        kolon_renk = "red" if self.kanser_riskleri["kolon"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
            text="Kolon Kanseri",
            width=140,
        ...
        rahim_renk = "red" if self.kanser_riskleri["rahim"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
            text="Rahim Kanseri",
            width=140,
        ...
        meme_renk = "red" if self.kanser_riskleri["meme"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
            text="Meme Kanseri",
            width=140,
        ...
        prostat_renk = "red" if self.kanser_riskleri["prostat"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
        ...
        farklı_renk = "red" if self.kanser_riskleri["farklı"] else "#1f6aa5"
        ctk.CTkButton(
            kanser_frame,
...
#SOYAĞACI KISMI (HOCAM ÇOK KARMAŞIK OLABİLDİĞİNCE DÜZGÜN YAZDIRIYOM )
    ...
    def soyagaci_ciz(self):
        ...
        for yakinlik, isim, soyisim, cinsiyet, yas, kanser_varmi, kanser_turu in self.aile_bireyleri:
    ...
    """, (self.aktif_hasta_id,))
        ...
        for yakinlik, isim, soyisim, cinsiyet, yas, kanservarmı, kanserturu in self.aile_bireyleri:

            if yakinlik in ("anne", "baba", "kardes"):

                if kanservarmı == "var":

                    if kanserturu in self.kanser_riskleri:
                        self.kanser_riskleri[kanserturu] = True
                    else:
                        self.kanser_riskleri["farklı"] = True
